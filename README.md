# This is a platformio based build of the JC3248W535EN StationMeteo Package
...
## UI generators
This project ships with one LVGL UI export:
- `src/ui/` from EEZ Studio.

See `DOCUMENTATION.md` for the integration steps.
