...
typedef struct _objects_t {
    ...
    lv_obj_t *obj13;
    lv_obj_t *obj14;
    lv_obj_t *hourly_strip;
    lv_obj_t *hourly_icon_4;
    lv_obj_t *hourly_icon_2;
    lv_obj_t *hourly_icon_3;
    lv_obj_t *hourly_icon_1;
    lv_obj_t *hourly_icon_5;
    lv_obj_t *hourly_icon_0;
