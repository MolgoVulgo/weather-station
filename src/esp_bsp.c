...
static const char *TAG = "WeatherStationBsp";
...
esp_err_t bsp_i2c_init(void)
{
    ...
    const i2c_config_t i2c_conf = {
        ...
        .sda_io_num = QSPI_TOUCH_SDA,
        .sda_pullup_en = GPIO_PULLUP_DISABLE,
        .scl_io_num = QSPI_TOUCH_SCL,
...
esp_err_t bsp_display_new(const bsp_display_config_t *config, esp_lcd_panel_handle_t *ret_panel, esp_lcd_panel_io_handle_t *ret_io)
{
    ...
    const esp_lcd_panel_io_spi_config_t io_config = AXS15231B_PANEL_IO_QSPI_CONFIG(QSPI_CS, NULL, NULL);
...
static lv_disp_t *bsp_display_lcd_init(const bsp_display_cfg_t *cfg)
{
    ...
    */
    ...
    const bsp_display_config_t bsp_disp_cfg = {
        ...
        .tear_cfg = BSP_SYNC_TASK_CONFIG(QSPI_TE, GPIO_INTR_NEGEDGE),
    };
...
esp_err_t bsp_touch_new(const bsp_display_cfg_t *config, esp_lcd_touch_handle_t *ret_touch)
{
    ...
    esp_lcd_touch_config_t tp_cfg = {
        ...
        .rst_gpio_num = QSPI_TOUCH_RST, // Shared with LCD reset
        .int_gpio_num = QSPI_TOUCH_INT,
